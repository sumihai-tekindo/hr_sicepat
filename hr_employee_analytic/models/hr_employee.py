...
class hr_employee(models.Model):
	...
	@api.depends('contract_ids.date_end','contract_ids.employee_id','contract_ids.date_start','contract_ids.working_hours','contract_ids.type_id')
	@api.multi
	...
	days_left = fields.Integer(string="Warning Date",compute='_get_days_left')
